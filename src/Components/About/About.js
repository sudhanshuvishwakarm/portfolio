...
export default function About() {
  return (
    ...
    <>
      <section id='about'  className=' flex flex-col items-center justify-center xs:mb-7 xs:mt-3 md:mt-0 md:h-[700px] text-black bg-white gap-y-5'>
        <div>
        <h1 className='xs:text-[22pt] leading-[32pt] text-center mt-8 mb-3'>ABOUT ME</h1>
